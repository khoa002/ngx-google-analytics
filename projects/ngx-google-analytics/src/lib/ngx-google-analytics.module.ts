...
export class NgxGoogleAnalyticsModule {
   ...
   */
  static forRoot(trackingCode: string, commands: IGoogleAnalyticsCommand[] = [], uri?: string, enableTracing?: boolean, additionalConfigSetupSettings?: {}): ModuleWithProviders {
    return {
